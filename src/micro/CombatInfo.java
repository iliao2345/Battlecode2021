...
public class CombatInfo {
	...
	public static double[][] compute_move_gains(RobotInfo empowering_robot) {  // computes the difference in optimal conviction gains for the empowering robot for every possible own robot move
		...
		outside_gains_2 = Math.min(outside_gains_1, outside_gains_2);
		outside_gains_4 = Math.min(outside_gains_2, outside_gains_4);
		outside_gains_5 = Math.min(outside_gains_4, outside_gains_5);
		outside_gains_8 = Math.min(outside_gains_5, outside_gains_8);
		outside_gains_9 = Math.min(outside_gains_8, outside_gains_9);
		inside_gains_8 = Math.min(inside_gains_9, inside_gains_8);
		inside_gains_5 = Math.min(inside_gains_8, inside_gains_5);
		inside_gains_4 = Math.min(inside_gains_5, inside_gains_4);
		inside_gains_2 = Math.min(inside_gains_4, inside_gains_2);
		inside_gains_1 = Math.min(inside_gains_2, inside_gains_1);
		...
		for (Direction dir:Direction.allDirections()) {
			...
			case 2: {move_gains[dir.dx+1][dir.dy+1] = Math.min(inside_gains_2, outside_gains_1); break;}
			case 4: {move_gains[dir.dx+1][dir.dy+1] = Math.min(inside_gains_4, outside_gains_2); break;}
			case 5: {move_gains[dir.dx+1][dir.dy+1] = Math.min(inside_gains_5, outside_gains_4); break;}
			case 8: {move_gains[dir.dx+1][dir.dy+1] = Math.min(inside_gains_8, outside_gains_5); break;}
			case 9: {move_gains[dir.dx+1][dir.dy+1] = Math.min(inside_gains_9, outside_gains_8); break;}
	...
	public static int[][] compute_empower_gains(RobotInfo empowering_robot, RobotInfo[] considered_robots, RobotInfo additional_robot) {
		...
		n_8 = Math.max(n_8, 1);
		n_9 = Math.max(n_9, 1);
		int damage_1 = Math.max(0, (((int)(empowering_robot.conviction*Info.empower_buff))-GameConstants.EMPOWER_TAX)/n_1);
		int damage_2 = Math.max(0, (((int)(empowering_robot.conviction*Info.empower_buff))-GameConstants.EMPOWER_TAX)/n_2);
		int damage_4 = Math.max(0, (((int)(empowering_robot.conviction*Info.empower_buff))-GameConstants.EMPOWER_TAX)/n_4);
		int damage_5 = Math.max(0, (((int)(empowering_robot.conviction*Info.empower_buff))-GameConstants.EMPOWER_TAX)/n_5);
		int damage_8 = Math.max(0, (((int)(empowering_robot.conviction*Info.empower_buff))-GameConstants.EMPOWER_TAX)/n_8);
		int damage_9 = Math.max(0, (((int)(empowering_robot.conviction*Info.empower_buff))-GameConstants.EMPOWER_TAX)/n_9);
		if (empowering_robot.team==Info.enemy) {
			damage_1 = Math.max(0, (((int)(empowering_robot.conviction*Info.enemy_empower_buff))-GameConstants.EMPOWER_TAX)/n_1);
			damage_2 = Math.max(0, (((int)(empowering_robot.conviction*Info.enemy_empower_buff))-GameConstants.EMPOWER_TAX)/n_2);
			damage_4 = Math.max(0, (((int)(empowering_robot.conviction*Info.enemy_empower_buff))-GameConstants.EMPOWER_TAX)/n_4);
			damage_5 = Math.max(0, (((int)(empowering_robot.conviction*Info.enemy_empower_buff))-GameConstants.EMPOWER_TAX)/n_5);
			damage_8 = Math.max(0, (((int)(empowering_robot.conviction*Info.enemy_empower_buff))-GameConstants.EMPOWER_TAX)/n_8);
			damage_9 = Math.max(0, (((int)(empowering_robot.conviction*Info.enemy_empower_buff))-GameConstants.EMPOWER_TAX)/n_9);
		}
		int kills_1 = -1;
		int kills_2 = -1;
		int kills_4 = -1;
		...
		for (int i=considered_robots.length; --i>=0;) {
			...
			if (empowering_robot.team==robot.team) {
				...
				case ENLIGHTENMENT_CENTER: {
					...
					case 1: {costs_1 += damage_1;
					costs_2 += damage_2;
					costs_4 += damage_4;
					costs_5 += damage_5;
					costs_8 += damage_8;
					costs_9 += damage_9; break;}
					case 2: {costs_2 += damage_2;
					costs_4 += damage_4;
					costs_5 += damage_5;
					costs_8 += damage_8;
					costs_9 += damage_9; break;}
					case 4: {costs_4 += damage_4;
					costs_5 += damage_5;
					costs_8 += damage_8;
					costs_9 += damage_9; break;}
					case 5: {costs_5 += damage_5;
					costs_8 += damage_8;
					costs_9 += damage_9; break;}
					case 8: {costs_8 += damage_8;
					costs_9 += damage_9; break;}
				...
				int conviction = robot.conviction;
				switch (Info.loc.distanceSquaredTo(robot.location)) {
				case 1: {kills_1 += (damage_1>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_1 += Math.max(0, damage_1-conviction);
				kills_2 += (damage_2>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_2 += Math.max(0, damage_2-conviction);
				kills_4 += (damage_4>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_4 += Math.max(0, damage_4-conviction);
				kills_5 += (damage_5>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_5 += Math.max(0, damage_5-conviction);
				kills_8 += (damage_8>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_8 += Math.max(0, damage_8-conviction);
				kills_9 += (damage_9>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_9 += Math.max(0, damage_9-conviction); break;}
				case 2: {kills_2 += (damage_2>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_2 += Math.max(0, damage_2-conviction);
				kills_4 += (damage_4>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_4 += Math.max(0, damage_4-conviction);
				kills_5 += (damage_5>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_5 += Math.max(0, damage_5-conviction);
				kills_8 += (damage_8>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_8 += Math.max(0, damage_8-conviction);
				kills_9 += (damage_9>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_9 += Math.max(0, damage_9-conviction); break;}
				case 4: {kills_4 += (damage_4>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_4 += Math.max(0, damage_4-conviction);
				kills_5 += (damage_5>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_5 += Math.max(0, damage_5-conviction);
				kills_8 += (damage_8>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_8 += Math.max(0, damage_8-conviction);
				kills_9 += (damage_9>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_9 += Math.max(0, damage_9-conviction); break;}
				case 5: {kills_5 += (damage_5>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_5 += Math.max(0, damage_5-conviction);
				kills_8 += (damage_8>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_8 += Math.max(0, damage_8-conviction);
				kills_9 += (damage_9>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_9 += Math.max(0, damage_9-conviction); break;}
				case 8: {kills_8 += (damage_8>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_8 += Math.max(0, damage_8-conviction);
				kills_9 += (damage_9>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_9 += Math.max(0, damage_9-conviction); break;}
				case 9: {kills_9 += (damage_9>conviction)?NEUTRAL_EC_UNIT_EQUIVALENT:0; costs_9 += Math.max(0, damage_9-conviction); break;}
				}
			}
			else {
				switch (robot.type) {
				case ENLIGHTENMENT_CENTER: {
					int conviction = robot.conviction;
					switch (Info.loc.distanceSquaredTo(robot.location)) {
					case 1: {kills_1 += (damage_1>conviction)?EC_UNIT_EQUIVALENT:0; costs_1 += damage_1;
					kills_2 += (damage_2>conviction)?EC_UNIT_EQUIVALENT:0; costs_2 += damage_2;
					kills_4 += (damage_4>conviction)?EC_UNIT_EQUIVALENT:0; costs_4 += damage_4;
					kills_5 += (damage_5>conviction)?EC_UNIT_EQUIVALENT:0; costs_5 += damage_5;
					kills_8 += (damage_8>conviction)?EC_UNIT_EQUIVALENT:0; costs_8 += damage_8;
					kills_9 += (damage_9>conviction)?EC_UNIT_EQUIVALENT:0; costs_9 += damage_9; break;}
					case 2: {kills_2 += (damage_2>conviction)?EC_UNIT_EQUIVALENT:0; costs_2 += damage_2;
					kills_4 += (damage_4>conviction)?EC_UNIT_EQUIVALENT:0; costs_4 += damage_4;
					kills_5 += (damage_5>conviction)?EC_UNIT_EQUIVALENT:0; costs_5 += damage_5;
					kills_8 += (damage_8>conviction)?EC_UNIT_EQUIVALENT:0; costs_8 += damage_8;
					kills_9 += (damage_9>conviction)?EC_UNIT_EQUIVALENT:0; costs_9 += damage_9; break;}
					case 4: {kills_4 += (damage_4>conviction)?EC_UNIT_EQUIVALENT:0; costs_4 += damage_4;
					kills_5 += (damage_5>conviction)?EC_UNIT_EQUIVALENT:0; costs_5 += damage_5;
					kills_8 += (damage_8>conviction)?EC_UNIT_EQUIVALENT:0; costs_8 += damage_8;
					kills_9 += (damage_9>conviction)?EC_UNIT_EQUIVALENT:0; costs_9 += damage_9; break;}
					case 5: {kills_5 += (damage_5>conviction)?EC_UNIT_EQUIVALENT:0; costs_5 += damage_5;
					kills_8 += (damage_8>conviction)?EC_UNIT_EQUIVALENT:0; costs_8 += damage_8;
					kills_9 += (damage_9>conviction)?EC_UNIT_EQUIVALENT:0; costs_9 += damage_9; break;}
					case 8: {kills_8 += (damage_8>conviction)?EC_UNIT_EQUIVALENT:0; costs_8 += damage_8;
					kills_9 += (damage_9>conviction)?EC_UNIT_EQUIVALENT:0; costs_9 += damage_9; break;}
					case 9: {kills_9 += (damage_9>conviction)?EC_UNIT_EQUIVALENT:0; costs_9 += damage_9; break;}
					}
					break;}
				case POLITICIAN: {
					int influence = robot.influence;
