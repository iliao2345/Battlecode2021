...
//	public static int STOP_ECONOMY_TIME = 1050;
	...
	public static int unhandled_muckraker_id_128;
	...
	public static void initialize() throws GameActionException {
		...
		targetting_guard_ids = new int[128];
		targetting_guard_signal_rounds = new int[128];
	}
	...
	public static void update() throws GameActionException {
		...
		enemy_muckraker_ids_exist = new boolean[128];
				...
				if (flag>>23==1) {
					...
					if (flag%2==1) {
						...
						if (targetting_guard_signal_rounds[(flag>>6)%128]<=Info.round_num-3 && min_unhandled_muckraker_distance>distance) {
							...
							unhandled_muckraker_id_128 = (flag>>6)%128;
						}
					}
...
//					}
		...
		slanderer_flag = (min_muckraker_alert_distance>10 && (Info.conviction+13*total_income<weakest_ec_influence || min_muckraker_alert_distance>100000) && (last_slanderer_built_round+8<=Info.round_num || max_safe_build_limit>=949) && seen_some_area || map_controlled && n_guard_ids>1.5*n_slanderer_ids+15) && Info.round_num<STOP_ECONOMY_TIME && !exterminate_flag;
		guard_flag = (embezzle_income>n_enemy_muckraker_ids_nearby*5 && min_muckraker_alert_distance<=25 && seen_some_area || map_controlled && n_guard_ids<=1.5*n_slanderer_ids+15) && !exterminate_flag;
