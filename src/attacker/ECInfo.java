...
public class ECInfo {
	...
	public static void update() throws GameActionException {
		...
		map_filled = rc.getRobotCount()>0.9*32*32;
		...
		desired_guard_flag = (min_muckraker_alert_distance>15 && Info.round_num<70 && n_slanderer_ids<=0.1*n_unclassified_ids || Info.round_num>400 && all_ecs_buried && n_relayer_ids>100) && Info.round_num<STOP_ECONOMY_TIME && !exterminate_flag;
