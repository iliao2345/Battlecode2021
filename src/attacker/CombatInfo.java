...
public class CombatInfo {
	...
	public static void compute_self_empower_gains() {
		...
		damage_1 = Math.max(0, (((int)(Info.conviction*Info.empower_buff))-GameConstants.EMPOWER_TAX)/n_1);
		damage_2 = Math.max(0, (((int)(Info.conviction*Info.empower_buff))-GameConstants.EMPOWER_TAX)/n_2);
		damage_4 = Math.max(0, (((int)(Info.conviction*Info.empower_buff))-GameConstants.EMPOWER_TAX)/n_4);
		damage_5 = Math.max(0, (((int)(Info.conviction*Info.empower_buff))-GameConstants.EMPOWER_TAX)/n_5);
		damage_8 = Math.max(0, (((int)(Info.conviction*Info.empower_buff))-GameConstants.EMPOWER_TAX)/n_8);
		damage_9 = Math.max(0, (((int)(Info.conviction*Info.empower_buff))-GameConstants.EMPOWER_TAX)/n_9);
	}
