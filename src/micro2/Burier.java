...
//			if (illegal_or_near_targetter_tiles[dir.dx+1][dir.dy+1]) {
//				rc.setIndicatorDot(Info.loc.add(dir), 255, 0, 0);
//			}
//			else {
//				rc.setIndicatorDot(Info.loc.add(dir), 0, 255, 0);
//			}
		}
    	if (Pathing.stick(target_ec.location, illegal_or_near_targetter_tiles)) {return true;}
    	rc.setIndicatorLine(Info.loc, Info.loc.translate(10, 10), 255, 0, 0);
